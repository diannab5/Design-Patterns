...
public class Persoana implements IPersoana{
	...
	public int getVarsta(){
		...
		if(an==0) {
			throw new IllegalArgumentException("Nu se poate determina anul asta");
		}
		...
		if(varsta_zile<0) {
			throw new IllegalArgumentException("Persoana nu s-a nascut inca!");
		}
	...
	public boolean checkCNP(){
		...
		if(CNP.charAt(0)=='0') {
			throw new ExceptieCNP("CNP-ul nu poate avea 0 pe prima pozitie");
		}
